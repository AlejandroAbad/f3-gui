...
export const CodigoSolicitante = ({ refFiltro }) => {
	...
	return <BoxFiltro relleno={solicitantes?.length} modoFiltro={modoFiltro} >
		...
		/>
		<Typography variant="caption" sx={{ color: 'text.secondary' }}>¿Quién realiza la transmisión? Un código de laboratorio, F+Online, un 101xxxxx@hefame, un BF02904xxxxx ... </Typography>
